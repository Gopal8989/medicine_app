...
class App extends React.Component {
  ...
  <Route path='/otp' component={otp}/>
    ...
    <p className="weee">We are here for your care 24/7.Any help just call us.</p>
    {this.state.show == false ? ( <Link to="/login"> <button className="bu btn-primary btn-lg disabled" onClick={this.hidehandle}>MAKE AN APPOINTMENT</button></Link>):(null)}
    {this.state.show == false ? (       <Link to="/Help"> <button className="buu btn-primary btn-lg disabled" onClick={this.hidehandle}>Help</button></Link>):(null)}
